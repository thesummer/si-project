...
\begin{tabular}{p{0.35\textwidth}p{0.075\textwidth}p{0.075\textwidth}p{0.075\textwidth}p{0.075\textwidth}p{0.25\textwidth}}
\hline
...
%
A software tool to analyse L1b raw data values (un-calibrated science data) will also be developed. 
%
